...
( cd "$root/fbthrift" ; git checkout --force "317752a" )
( cd "$root/fizz" ; git checkout --force "f719977" )
( cd "$root/folly" ; git checkout --force "0a3f724" )
( cd "$root/wangle" ; git checkout --force "f3f367a" )