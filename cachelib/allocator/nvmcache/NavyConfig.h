...
class KangarooConfig {
 public:
  ...
  KangarooConfig& setThreshold(double flushingThreshold,
                            double gcUpperThreshold,
                            double gcLowerThreshold) noexcept {
    flushingThreshold_ = flushingThreshold;
    gcUpperThreshold_ = gcUpperThreshold;
    gcLowerThreshold_ = gcLowerThreshold;
    return *this;
  }

  KangarooConfig& setSetOverprovisioning(double setOverprovisioning) noexcept {
    setOverprovisioning_ = setOverprovisioning;
    return *this;
  }
  ...
  double getFlushingThreshold() const {return flushingThreshold_; }
  double getGcUpperThreshold() const {return gcUpperThreshold_; }
  double getGcLowerThreshold() const {return gcLowerThreshold_; }
  double getSetOverprovisioning() const {return setOverprovisioning_;}
 ...
 private:
  ...
  double flushingThreshold_{.2};
  double gcUpperThreshold_{.1};
  double gcLowerThreshold_{.05};
  double setOverprovisioning_{.05};
};
...
class NavyConfig {
 ...
 public:
  ...
  void setKangaroo(unsigned int kangarooSizePct,
                  ...
                  double kangarooFlushingThreshold,
                  double kangarooGcUpperThreshold,
                  double kangarooGcLowerThreshold,
                  double kangarooSetOverprovisioning);
