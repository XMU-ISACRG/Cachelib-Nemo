...
void NavyConfig::setKangaroo(unsigned int kangarooSizePct,
  ...
  kangarooConfig_
      ...
      .setThreshold(kangarooFlushingThreshold, kangarooGcUpperThreshold, kangarooGcLowerThreshold)
      .setSetOverprovisioning(kangarooSetOverprovisioning);
}
...
std::map<std::string, std::string> NavyConfig::serialize() const {
  ...
  //【TODO】whether to have znskvcache settings
