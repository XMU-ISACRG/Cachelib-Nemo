...
class KangarooProto {
 public:
  ...
  virtual void setThreshold(double flushingThreshold,
                            double gcUpperThreshold,
                            double gcLowerThreshold) = 0;

  virtual void setSetOverprovisioning(double setOverprovisioning) = 0;
};
...
// Creates Kangaroo engine prototype
