...
class FOLLY_PACK_ATTR RegionBucketStorage {
 public:
  // This is an allocation that is returned to user when they
  // allocate from the RegionBucketStorage. "view" is for reading
  ...
  explicit RegionBucketStorage(uint32_t capacity) : capacity_{capacity} {}
