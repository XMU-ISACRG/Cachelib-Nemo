...
std::string getTimestampedPrefix() {
...
std::string getTimestampedLogFileName(int totalIterations) {
  ...
  return "/home/nemo/Nemo/cachelib/log/" + std::string(buffer) + "_iter" + std::to_string(totalIterations) + ".log";
}
...
int main(int argc, char** argv) {
  ...
  std::string logHomePath = "/home/nemo/Nemo/cachelib/log/";
  std::string timePrefix = getTimestampedPrefix();
  std::string logFileName = logHomePath + timePrefix + "_run.log";
  std::string progressFileName = logHomePath + timePrefix + "_progress.log";

  std::cout << "logFile: " << logFileName << std::endl;
  std::cout << "progress_stats_file: " << progressFileName << std::endl;

  gflags::SetCommandLineOption("progress_stats_file", progressFileName.c_str());

  XLOGToLocalFile(logFileName);
