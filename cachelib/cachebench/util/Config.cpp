...
CacheBenchConfig::CacheBenchConfig(
  ...
  XLOG(INFO) << "===JSON Config===";
  XLOG(INFO) << configString;
  ...
  // stressConfig is decided by testConfig
...
ReplayGeneratorConfig::ReplayGeneratorConfig(const folly::dynamic& configJson) {
  ...
  std::cout << "replaySerializationMode: " << replaySerializationMode << std::endl;
  std::cout << "relaxedSerialIntervalMs: " << relaxedSerialIntervalMs << std::endl;
  std::cout << "numAggregationFields: " << numAggregationFields << std::endl;
  std::cout << "numExtraFields: " << numExtraFields << std::endl;
  for (auto field : statsPerAggField)
    std::cout << "statsPerAggField: " << field.first << ", " << std::endl;
