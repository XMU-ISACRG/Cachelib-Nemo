...
CacheConfig::CacheConfig(const folly::dynamic& configJson) {
  ...
  JSONSetVal(configJson, navyZNSKVCacheSizePct);
  JSONSetVal(configJson, navyZNSKVCacheBucketSize);
  JSONSetVal(configJson, navyZNSKVCacheBucketRatio);
  JSONSetVal(configJson, navyZNSKVCacheBloomFilterFp);
  JSONSetVal(configJson, navyZNSKVCacheElementCountPerPBF);
  JSONSetVal(configJson, navyZNSKVCacheEnableWriteBack);
  JSONSetVal(configJson, navyZNSKVCacheStartStatZone);
  JSONSetVal(configJson, navyZNSKVCacheStep);

  JSONSetVal(configJson, navyZNSKVCacheEnableDoubleHash);
  JSONSetVal(configJson, navyZNSKVCacheEnableDoubleBuffer);
  JSONSetVal(configJson, navyZNSKVCacheEnableKickOff);
  JSONSetVal(configJson, navyZNSKVCacheMaxNumKicks);
