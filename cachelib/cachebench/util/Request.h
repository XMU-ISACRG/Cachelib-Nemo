...
struct Request {
  ...
  static std::string OpTypeToString(OpType op) {
    switch (op) {
      case OpType::kSet: return "kSet";
      case OpType::kGet: return "kGet";
      case OpType::kDel: return "kDel";
      case OpType::kAddChained: return "kAddChained";
      case OpType::kLoneGet: return "kLoneGet";
      case OpType::kLoneSet: return "kLoneSet";
      case OpType::kUpdate: return "kUpdate";
      case OpType::kCouldExist: return "kCouldExist";
      case OpType::kSize: return "kSize";
