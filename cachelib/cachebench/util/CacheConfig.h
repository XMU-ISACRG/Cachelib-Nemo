...
struct CacheConfig : public JSONConfig {
  ...
  double navyKangarooFlushingThreshold = 0.2;
  double navyKangarooGcUpperThreshold = 0.1;
  double navyKangarooGcLowerThreshold = 0.05;
  double navyKangarooSetOverprovisioning = 0.05;
